...
STATS_CHANNEL_LINK = "https://t.me/teacherZBMU"
STATS_CHANNEL_HANDLE = "@teacherZBMU"
...
async def confirm(call: CallbackQuery, state: FSMContext):
    ...
    if call.data == "✅ ثبت نهایی":
        ...
        final_text = (
            ...
            f"📊 برای دیدن آمار و نتایج استادها:\n"
            f'👉 <a href="{STATS_CHANNEL_LINK}">{STATS_CHANNEL_HANDLE}</a>\n\n'
            f"📢 کانال اصلی:\n"
